...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/org/new", authorize(reqGrafanaAdmin, ac.EvalPermission(ActionOrgsCreate)), hs.Index)
	...
	r.Get("/admin/orgs", authorize(reqGrafanaAdmin, orgsAccessEvaluator), hs.Index)
	r.Get("/admin/orgs/edit/:id", authorize(reqGrafanaAdmin, orgsAccessEvaluator), hs.Index)
